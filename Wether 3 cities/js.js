let url1 = "http://api.openweathermap.org/data/2.5/weather?id=703448&appid=bf35cac91880cb98375230fb443a116f&lang=ru";
let url2 = "http://api.openweathermap.org/data/2.5/weather?id=2643743&appid=bf35cac91880cb98375230fb443a116f&lang=ru";
let url3 = "http://api.openweathermap.org/data/2.5/weather?id=5128638&appid=bf35cac91880cb98375230fb443a116f&lang=ru";

let container = document.querySelector('.container');

async function getWheather(url) {
...
getWheather(url1).then((data) => {
    document.body.append(newBox(data));
});
getWheather(url2).then((data) => {
    document.body.append(newBox(data));
});
getWheather(url3).then((data) => {
    document.body.append(newBox(data));
});
...
function newBox(data) {
    ...
    p3.innerHTML = `ветер ${data.wind['speed']}м/с`;
